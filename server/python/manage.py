...
tiles = gp.read_file('https://ookla-open-data.s3-us-west-2.amazonaws.com/shapefiles/performance/type%3Dfixed/year%3D2020/quarter%3D2/2020-04-01_performance_fixed_tiles.zip')

county_url = "https://www2.census.gov/geo/tiger/TIGER2019/COUNTY/tl_2019_us_county.zip" 
orlando = gp.read_file(county_url)

ky_counties = orlando.loc[orlando['STATEFP'] == '21'].to_crs(4326)
